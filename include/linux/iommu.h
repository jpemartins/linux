 ...
 * @get_dirty_tracking: Dirty tracking status on the iommu domain
...
struct iommu_domain_ops {
	...
	int (*get_dirty_tracking)(struct iommu_domain *domain);
...
{
	unsigned long nbits = iova_bitmap_set(dirty->bitmap, iova, length);
